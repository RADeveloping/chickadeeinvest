...
namespace chickadee.Controllers
{
    public class CompanyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,Name,Logo,PhoneNumber,Email")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,Name,Logo,PhoneNumber,Email")] Company company)
        {
